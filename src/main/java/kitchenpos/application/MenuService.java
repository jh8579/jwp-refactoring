...
public class MenuService {
    ...
    public MenuDto create(final MenuDto menuDto) {
        ...
        final Map<Long, Product> productMap = menuDto.getMenuProducts()
                                                 .stream()
        ...
        menu.validateMenuProductPrice(productMap);
    ...
    public List<MenuDto> list() {
        ...
        return menus.stream().map(MenuDto::from).collect(Collectors.toList());
    }
}
